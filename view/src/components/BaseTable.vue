...
export default {
  ...
  data: function () {
    return {
      ...
      show_table_footer: "show_table_footer_from_parent" in this.$props && this.$props["show_table_footer_from_parent"]=== "false" ? false : true,
