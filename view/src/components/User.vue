...
export default {
  ...
  data: function () {
    return {
      ...
      total_data: [],
      resource_url: process.env.VUE_APP_API_ENDPOINT + "/api/v1/users",
      resource_filter: {},
      form_name: "UserForm",
      modal_name: "modal-customer-form",
      export_file_name: "danh_sach_khach_hang_" + moment().format("DD_MM_YYYY"),
    };
  },
};
</script>
