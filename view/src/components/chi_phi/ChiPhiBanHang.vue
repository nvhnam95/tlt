...
export default {
  components: {
    ...
    return {
      ...
      resource_url: process.env.VUE_APP_API_ENDPOINT + "/api/v1/costs?cost_type=CPBANHANG",
      resource_filter: {cost_type: "CPBANHANG"},
      form_name: "ChiPhiForm",
      modal_name: "modal-chi-phi-ban-hang-form",
      export_file_name: "chi_phi_ban_hang_" + moment().format("DD_MM_YYYY"),
    }
  }
}
</script>
