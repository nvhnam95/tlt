...
export default {
  components: {
    ...
    return {
      ...
      resource_url: process.env.VUE_APP_API_ENDPOINT + "/api/v1/costs?cost_type=CPKHAC",
      resource_filter: {cost_type: "CPKHAC"},
      form_name: "ChiPhiForm",
      modal_name: "modal-chi-phi-khac-form",
      export_file_name: "chi_phi_khac_" + moment().format("DD_MM_YYYY"),
    }
  }
}
</script>
