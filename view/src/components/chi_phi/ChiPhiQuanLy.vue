...
export default {
  components: {
    ...
    return {
      ...
      resource_url: process.env.VUE_APP_API_ENDPOINT + "/api/v1/costs?cost_type=CPQUANLY",
      resource_filter: {cost_type: "CPQUANLY"},
      form_name: "ChiPhiForm",
      modal_name: "modal-chi-phi-quan-ly-form",
      export_file_name: "chi_phi_quan_ly_" + moment().format("DD_MM_YYYY"),
    }
  }
}
</script>
